...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@ApiPlatform/DataCollector/request.html.twig", "/home/alpha/jonijoni/vendor/api-platform/core/src/Bridge/Symfony/Bundle/Resources/views/DataCollector/request.html.twig");
    }
}
