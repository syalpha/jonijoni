...
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AdminFixture(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ProfilFixture(), 'groups' => []]]);
